...
/* 	GÖREV 3:
    ...
    en küçük sayı ile en büyük sayıyı bu değişkenlere atayın. (for döngüsü kullanın)
		...
		3b. `ucetambolunenler` adında bir dizi tanımlayın ve 
    bu diziye sayilar dizisindeki 3'ün tam katı olan sayıları atayın (.forEach metodunu kullanın)
    ...
    sayilar dizisinin içindeki 500'den küçük sayıları bu diziye atayın (.filter metodunu kullanın)
    ...
    bazı sayılar birden fazla kere yazılmış. sayilar dizisi içerisinde 
    birden fazla kez yazılmış sayıları tespit ederek kaç kere tekrar edildiğini 
